  ...
  return (
    <>
      <Row className='map-first-row'>
        ...
        <Col>
          <div>
            <div class='color-bar-map'>
              <span className='pull-left'>MIN</span>
              <span className='float-right'>MAX</span>
            </div>
            <div className='color-bar-text'></div>
          </div>
        </Col>
      </Row>
                          ...
                          setTooltipContent(
                            d == undefined ? (
                              ...
                              <div>
                                ...
                                {d['cases'].toLocaleString()} <br />
                                <FormattedMessage id='deaths' /> :{' '}
                                {d['deaths'].toLocaleString()}
                                <br />
                                <FormattedMessage id='today_cases' /> :{' '}
